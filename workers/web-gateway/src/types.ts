...
export type GatewayEnv = {
  ...
  OFFPAY_SOLANA_MAINNET_EXPLORER_TX_URL_TEMPLATE?: string;
  OFFPAY_SOLANA_DEVNET_EXPLORER_TX_URL_TEMPLATE?: string;
  OFFPAY_SOLANA_TESTNET_EXPLORER_TX_URL_TEMPLATE?: string;
  ...
  MAGICBLOCK_PRIVATE_PAYMENTS_API_ORIGIN?: string;
